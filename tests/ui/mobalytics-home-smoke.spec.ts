 ...
 */
test.describe("Mobalytics Home Page — Smoke Tests", { tag: [Tags.ui, Tags.smoke] }, () => {
  test.beforeEach(async ({ homePage }) => {
    await homePage.navigate();
  });

  test("should load home page successfully", { tag: Tags.critical }, async ({ homePage }) => {
  ...
  test("should display correct page title", { tag: Tags.critical }, async ({ homePage }) => {
    await test.step("Verify page title contains Mobalytics", async () => {
      await homePage.verifyPageTitle("Mobalytics");
    });
  });

  test("should display main heading with million gamers text", {}, async ({ homePage }) => {
  ...
  test("should display download button", { tag: Tags.critical }, async ({ homePage }) => {
  ...
  test("should display navigation menu items", { tag: Tags.navigation }, async ({ homePage }) => {
